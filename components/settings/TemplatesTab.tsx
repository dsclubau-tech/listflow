              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center gap-2 bg-black/0 opacity-0 transition-colors group-hover:bg-black/20 group-hover:opacity-100">
                  ...
                  <button
                    ...
                    title="Delete"
                  >
                    <svg className="h-4 w-4 text-quaternary" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded-md border border-quaternary px-3 py-2 text-sm text-quaternary transition-colors hover:bg-quaternary-soft"
                      >
                        Delete
                      </button>
                    </div>
